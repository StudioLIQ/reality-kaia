...
contract Reality_Fees_Disputes is Reality_Fixture {
    ...
    function test_arbitration_prevents_further_answers() public {
        ...
        bytes32 qid = askWithBondToken(1, "Binary arbitration test", address(arbitrator), timeoutSec, openingTs, address(usdt));
    ...
    function test_competition_with_increasing_fees() public {
        ...
        assertEq(
            usdt.balanceOf(FEE) - initialFeeBalance,
            cumulativeFees,
            "Total fees collected should match cumulative"
        );
    }
    ...
    function test_arbitrator_immediate_finalization() public {
        ...
        bytes32 qid = askWithBondToken(1, "Immediate arbitration", address(arbitrator), timeoutSec, openingTs, address(usdt));
    ...
    function test_fee_recipient_accumulation() public {
        ...
        assertEq(
            usdt.balanceOf(FEE) - initialBalance,
            expectedTotalFees,
            "Fee recipient should accumulate all fees"
        );
    }
}